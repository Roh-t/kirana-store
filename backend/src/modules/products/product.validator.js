...
export class ProductValidator {
  static validateCreateProduct(data) {
    ...
    return {
      ...
      sourceName: data.sourceName ? data.sourceName.trim() : null,
      sourceImage: data.sourceImage ? data.sourceImage.trim() : null,
      sourcePrice: data.sourcePrice !== undefined ? Number(data.sourcePrice) : null,
      sourceOriginalPrice: data.sourceOriginalPrice !== undefined ? Number(data.sourceOriginalPrice) : null,
      sourceQuantity: data.sourceQuantity ? data.sourceQuantity.trim() : null,
      exactCategory: data.exactCategory ? data.exactCategory.trim() : null,
      subCategory: data.subCategory ? data.subCategory.trim() : null,
      sourceCategory: data.sourceCategory ? data.sourceCategory.trim() : null,
      hindiName: data.hindiName ? data.hindiName.trim() : null,
      hinglishName: data.hinglishName ? data.hinglishName.trim() : null,
      indianCategory: data.indianCategory ? data.indianCategory.trim() : null,
      indianSubCategory: data.indianSubCategory ? data.indianSubCategory.trim() : null,
